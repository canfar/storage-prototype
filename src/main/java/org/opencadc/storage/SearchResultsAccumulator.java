...
public class SearchResultsAccumulator implements Accumulator<String, ArrayList<String>>
{
     ...
     */
    @Override
    public void merge(Accumulator<String, ArrayList<String>> other)
    {
        final Stream<String> stream = Stream.concat(results.stream(), other.getLocalValue().stream());
        results.clear();
     ...
     */
    @Override
    public Accumulator<String, ArrayList<String>> clone()
    {
        final SearchResultsAccumulator clonedValue = new SearchResultsAccumulator();

        clonedValue.results.addAll(this.results);
